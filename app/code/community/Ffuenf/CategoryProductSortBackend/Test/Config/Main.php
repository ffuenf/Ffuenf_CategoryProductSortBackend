...
class Ffuenf_CategoryProductSortBackend_Test_Config_Main extends EcomDev_PHPUnit_Test_Case_Config
{
    /**
    ...
    public function testHelperAliases()
    {
        $this->assertHelperAlias(
            ...
            'Ffuenf_CategoryProductSortBackend_Helper_Data'
        );
    }

    /**
     * Tests whether extension resource model aliases are returning the correct class names
     *
     * @test
     */
    public function testResourceModelAliases()
    {
        $this->assertModelAlias(
            'ffuenf_categoryproductsortbackend/resource_product',
            'Ffuenf_CategoryProductSortBackend_Model_Resource_Product'
        );
    }
    ...
    public function testLayoutFileDefinition()
    {
        $this->assertLayoutFileDefined(
            'adminhtml',
            'categoryproductsortbackend.xml',
            'ffuenf_categoryproductsortbackend'
        );
